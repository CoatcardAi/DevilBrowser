...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  aiGetPageText:    () => ipcRenderer.invoke('ai-get-page-text'),
  aiGetPageDOM:     () => ipcRenderer.invoke('ai-get-page-dom'),
  aiExecutePageAction: (script) => ipcRenderer.invoke('ai-execute-page-action', script),
